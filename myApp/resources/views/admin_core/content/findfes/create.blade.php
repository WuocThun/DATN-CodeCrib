        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="ml-sm-auto col">
                    ...
                    <form action="{{route('findfes.store') }}" id="form_dangtin" class="form-horizontal js-form-submit-data js-frm-manage-post"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control js-title"  value="{{old('title')}}" name="title" id="title"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <textarea  class="form-control js-content"  name="description" id="description"
                                            ...
                                            data-msg-minlength="Nội dung tối thiểu 100 kí tự"--}}  >{{old('description')}}</textarea>
                                    </div>
                                    @error('description')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="ten_lien_he" type="text" value="{{old('contact_name')}}" name="contact_name" class="form-control"
                                            placeholder="Name"
                                               >
                                        </div>
                                        @error('contact_name')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input id="giachothue" value="{{old('price')}}" name="price" pattern="[0-9.]+" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <input id="post_acreage" type="number" attern="[0-9.]+" value="{{old('area')}}" name="area"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            {{-- <label for="gender_rental">Gender Rental</label> --}}
