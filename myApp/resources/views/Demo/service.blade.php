...
.user-options1 .btn1.highlight1 {
  ...
  <body>
    <!-- Header -->
    <header>
      <div class="tongheader header-container">
        <div class="logo">
          <img
        ...
        <nav class="main-nav" style="position: relative; top: 10px;font-size: 17px;">
          <ul>
        ...
        <div class="user-options1">
          <button class="btn1">Yêu thích</button>
          <a href="login.html" style="text-decoration: none">
            <button class="btn1">Đăng nhập</button></a>
          <button class="btn1 highlight1">Đăng tin miễn phí</button>
        </div>
      </div>
    </header>
   ...
   <div> <h3 style="text-align: center; font-weight: bold ;margin-top: 30px;">
    ...
    <div class="tongmota">
      <div class="mota">
        ...
        <img src="/Demo/img/demo-vipnoibat.jpg" alt="vipnoibat" />
        <img src="/Demo/img/demo-vipnoibat2.jpg" alt="vipnoibat2" />
      </div>
    </div>
    <div class="tongmota">
      <div class="mota">
    ...
    <div class="cha">
      <div class="tongdg">
        <div class="danhgia">
          <div class="info">
            <img src="/Demo/img/default-user.png" alt="imguser" />
            <aside>
    ...
    <div class="tongtt">
      <div class="method">
        <div class="bank">
          <div class="img" style="margin-left: 10px">
            <img src="/Demo/img/bank-transfer.png" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/cash.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/momo.png" alt="bank-transfer" />
          </div>
          <strong>MOMO</strong>
        </div>
      </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/zalopay.png" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/qr-code.png" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/payment-method.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img" style="margin-left: 20px">
            <img src="/Demo/img/online-store.svg" alt="bank-transfer" />
          </div>
      ...
      <div class="method">
        <div class="bank">
          <div class="img">
            <img src="/Demo/img/credit-card.png" alt="bank-transfer" />
          </div>
