...
class InvoiceController extends Controller
{
    ...
    public function payInvoice($id)
    {
        ...
        return view('admin_core.content.invoices.pay',
            compact('invoice', 'getMotelName'));
    }

    public function getIndexInvoice()
    {
        $getUserId = Auth::id();
        $invoices  = Invoice::where('user_id', $getUserId)->with('motel')
                            ->get();
    ...
    public function prepay(Request $request)
    {
        ...
        return redirect()->back()->with('success',
            'Hóa đơn đã được trả trước thành công!');
    }
    ...
    public function acceptPay(Request $request, $id)
    {
        ...
        return redirect()->route('admin.invoices.getIndexInvoice')
                         ->with('success',
